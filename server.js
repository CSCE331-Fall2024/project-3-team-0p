...
async function addOrder(orderData) {
    try{
        ...
        const orderResult = await client.query("select max(id) as max_id from orders");
        ...
        const priceResult = await client.query("select price from mealsizes where mealname = $1", [orderData[0]]);
        ...
        const orderItemsResult = await client.query("select max(id) as max_id from orderitems");
        ...
        await client.query("INSERT INTO orders VALUES ($1, $2, $3, $4, $5)", [orderID, orderDate, orderTime, numItems, orderPrice]);
        await client.query("INSERT INTO orderitems VALUES ($1, $2, $3, $4, $5, $6, $7, $8)", [orderItemsID, orderID, orderItemPrice, orderData[0], orderData[1], orderData[2], orderData[3], orderData[4]]);
    } catch(e) {
